...
acessosPorDia l =  busca (limpaString l) []

busca :: [(String, String, String, String)] -> [(Int, Int)] -> [(Int, Int)]
busca [] l = l 
busca ((x0,x1,x2,x3):xs) l = busca xs (computa (read (drop 8 x0)) l)

computa :: Int -> [(Int, Int)] -> [(Int, Int)]
computa dia [] = [(dia, 1)]
computa dia ((a0,a1):as) | dia == a0 = ((a0, a1+1):as)
                         | otherwise = [(a0,a1)] ++ computa dia as
